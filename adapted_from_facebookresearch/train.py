...
def train(rank, local_rank, a, h):
    ...
    if cp_g is None or cp_do is None:
        ...
        # Handle size mismatches (e.g., when model_in_dim changes)
        generator_state_dict = state_dict_g['generator']
        filtered_state_dict = {}
    ...
    train_loader = DataLoader(trainset, num_workers=h.get("num_workers",0), shuffle=True, sampler=train_sampler,
